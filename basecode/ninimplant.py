...
def transform(points,
    ...
    rot_x = _rot_x(ROTATION_ANGLE_X)
    rot_y = _rot_y(ROTATION_ANGLE_Y)
    rot_z = _rot_z(ROTATION_ANGLE_Z)
    trans_x = _trans(TRANSLATION_X, 0, 0)
    trans_y = _trans(0, TRANSLATION_Y, 0)
    trans_z = _trans(0, 0, TRANSLATION_Z)
